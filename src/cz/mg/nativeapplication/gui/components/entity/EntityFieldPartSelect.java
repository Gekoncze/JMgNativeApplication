...
public @Utility class EntityFieldPartSelect implements RefreshableComponent {
    ...
    public EntityFieldPartSelect(
        ...
        this.createButton = new JButton(mainWindow.getIconGallery().getIcon(IconGallery.UNKNOWN));
        ...
        this.editButton = new JButton(mainWindow.getIconGallery().getIcon(IconGallery.UNKNOWN));
